...
CREATE TABLE `credit_transactions` (
  ...
  `units_used` decimal(15,6) DEFAULT '0.000000',
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Bảng lưu lịch sử giao dịch credit';
